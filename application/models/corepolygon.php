...
class CorePolygon extends DataMapper {

var $table    = 'core_polygons';
var $has_one  = array();
var $has_many = array();
...
//
// this function checks the geometries to make sure they're POLYGON or MULTIPOLYGON and if any are not, it throws an exception for the caller to handle
